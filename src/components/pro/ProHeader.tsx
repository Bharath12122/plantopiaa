  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
        <button className="w-full sm:w-auto bg-[#9b87f5] text-white px-8 py-4 rounded-lg text-xl font-semibold hover:bg-[#7E69AB] transition-all flex items-center justify-center gap-2">
      ...
      <p className="text-gray-400 text-center pt-4">
        ...
        <span className="text-[#9b87f5] cursor-pointer hover:underline">here</span>
      </p>
    </div>
  );
};